<?php
/**
 * Set of classes extracted from Symphony Framework
 */
class f_util_Finder
{
  protected $type        = 'file';
   ...
   *
   * f_util_Finder will descend at most $level levels of directories below the starting point.
   *
   * @param  integer level
   * @return object current f_util_Finder object
   */
   ...
   *
   * f_util_Finder will start applying tests at level $level.
   *
   * @param  integer level
   * @return object current f_util_Finder object
   */
   ...
   * @return object new f_util_Finder object
   */
  public static function type($name)
  {
    $finder = new f_util_Finder();
   ...
   *
   * @return object current pakef_util_Finder object
   */
 ...
 * @version    SVN: $Id: f_util_Finder.class.php 3268 2007-01-13 20:19:33Z fabien $
 */
class sfGlobToRegex
{
